...
# Ícone de calendário limpo e vetorial (sem numerais que causem confusão em telas móveis)
ICON_CALENDARIO = (
    '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" '
    'fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" '
    'style="vertical-align: -2px; display: inline-block; margin-right: 4px;">'
...
SETORES_PADRAO = [
    "Ambulância",
    "Banda principal",
    "Bolo fake / maquete do bolo",
    "Brinquedos Espaço Kids",
    "Buffet",
    "Cabine de fotos",
    "Carro da noiva",
    "Celebrante",
    ...
    "Fotógrafo",
    "Gerador de energia",
    "Hotel Noite de Núpcias",
    "Igreja / local da cerimônia",
    "Iluminação cênica",
    "Instrumento extra",
    "Lembranças (bem casados??)",
    "Limpeza / Vassourinha de ouro",
    "Luz / Som / Pista de dança",
    "Músicos cerimônia religiosa",
    "Recreação Infantil",
    "Salão de festas / sítio",
    "Segurança",
    "Sobremesa",
    "Tenda / palco / tablado",
    "Vans",
